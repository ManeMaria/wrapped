...
export const UserPage = () => {
  ...
  // Solicita permissão para reproduzir o áudio
  useEffect(() => {
    if (!isSuccess) return
  ...
  return (
    <div className="max-w-[600px] mx-auto relative h-dvh">
      <Curtain isVisible={openCurtain}>
        <Border>
          <Carousel.Root className="h-full">
            {() => (
              <>
                <Card key="card1">
                  {() => (
                    <div className="w-full px-6 pt-10 h-full grid">
                      ...
                      <h3 className="text-[55px] typing-effect typing-animated delay-2-5s">
                        Terra da
                      </h3>
                      <h3 className="text-[55px] typing-effect typing-animated delay-3s">
                        Loomi
                      </h3>
                      <div className="grid place-items-end animate__animated animate__fadeIn animate__delay-3s">
                ...
                <Card key="card3">
                  {(isCentered) => (
                    <div>
                      ...
                      <div className="grid place-items-center h-dvh w-full balance">
                        <img
                          loading="lazy"
                    ...
                    <div>
                      ...
                      <div className="grid place-items-center  w-full ">
                        <img
                          ...
                          alt="sky"
                          className="object-contain h-[15dvh]"
                        />
                        <span className="w-full overflow-y-hidden forward-movement h-[15dvh]">
                          <img
                            loading="lazy"
                ...
                <Card>
                  {(isCentered) => (
                    <div className={cn('text-[30px] p-8')}>
                      <div className="grid ">
                        <div
                          className={cn(
                            'typing-effect',
                      ...
                      <span className="relative w-full h-full grid gap-8">
                        {user?.projects
                          .split(', ')
                          .slice(0, 4)
                          .map((project, i) => (
                    ...
                    <div className={cn('text-[30px] ')}>
                      ...
                      >
                        ...
                        <img
                          ...
                          src="/assets/images/group2.png"
                          alt="group2"
                          className="object-contain absolute -bottom-[20%] left-0 -z-1"
                        />
                      </span>
                    </div>
                  )}
                ...
                <Card>
                  {(isCentered) => (
                    <div className="p-8 mt-auto">
                      ...
                      />
                      <div className="grid  text-[30px] mt-[5dvh]">
                        <div
                          className={cn(
                            'typing-effect',
                            isCentered && 'typing-animated ',
                      ...
                      <span
                        className={cn(
                          'relative w-full h-[40dvh] grid place-items-end',
                        )}
                      >
                        <img
                          loading="lazy"
                ...
                <Card>
                  {(isCentered) => (
                    <Local isVisible={isCentered}>
                      ...
                      >
                        <h2 className="text-[30px] typing-effect typing-animated text-center">
                          {user?.personality}
                        </h2>
                    ...
                    <div className={cn('text-[30px]')}>
                      ...
                      >
                        <img
                          ...
                          alt="brother"
                          className="object-contain w-[85%] h-full ml-auto mt-auto"
                        />
                      </span>
                    </div>
                  )}
                        ...
                        <div className="grid px-6">
                          ...
                          <div className="grid justify-start grid-cols-2 gap-2 size-full mt-4">
                            ...
                            >
                              ...
                              <span>Colaboração com outros Loomers</span>
                            </div>
                            <div
                              className={cn(
                                'text-[16px]',
                            ...
                            >
                              ...
                              <span>Loomer que mais colaborei</span>
                            </div>
                            <img
                              loading="lazy"
